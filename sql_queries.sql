...
from customer
group by gender
--2. which customers ysed a discount bill but still spent more than the average purchase amount ?
...
--4.compare the average purchaseamounts between standard and express shipping
